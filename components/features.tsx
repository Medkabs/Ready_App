        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,theme(colors.blue.400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-white-200/65">
                We UNDERSTAND that our CUSTOMERS are at the CENTER of our service. 
                Keeping you updated and satisfied ensures that we are doing our job right, 
                to fit your long-term business goals.
              </p>
            </article>
          </div>
        </div>
